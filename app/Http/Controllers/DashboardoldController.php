...
class DashboardController extends Controller
{
    public function admin()
    {
        ...
        return view('dashboard.admin',compact('products','designs','websites','orders','orders_count','revenue','employees','order_p','order_r','prod_p','cdaily_avg','pdaily_avg','avg_p'));
    }
