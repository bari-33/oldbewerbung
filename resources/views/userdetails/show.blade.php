        ...
        <div class="row">
            <div class="col-lg-4 col-xl-4">
                <div class="card-box text-center">
                    <img src="{!! asset('public/img/profiles/'.$userdetail->profile_picture) !!}" class="rounded-circle avatar-lg img-thumbnail"
                         alt="profile-image">

                    <h4 class="mb-0">{{$userdetail->name}}</h4>
                    <p class="text-muted">@ {{$userdetail->userdetail->username}}</p>

{{--                   <button type="button" class="btn btn-success btn-xs waves-effect mb-2 waves-light">Follow</button>--}}
{{--                    <button type="button" class="btn btn-danger btn-xs waves-effect mb-2 waves-light">Message</button>--}}

                    <div class="text-left mt-3">
                        <h4 class="font-13 text-uppercase"><strong>Biografische Angaben: </strong></h4>
                        <p class="text-muted font-13 mb-3">
                            {{$userdetail->userdetail->biographical_information}}
                        </p>
                        <p class="mb-2 font-13"><strong>Vollständiger Name :</strong> <span class="ml-2">{{
                        $userdetail->name
                        }}</span></p>

                        <p class="mb-2 font-13"><strong>Telefon :</strong><span class="ml-2">
                        ...
                        <p class="mb-1 font-13"><strong>Website :</strong> <span class="ml-2">
                                <a href="{{ $userdetail->userdetail->website }}">{{ $userdetail->userdetail->website }}</a>

                            </span></p>
                        <p class="mb-1 font-13"><strong>Facebook :</strong> <span class="ml-2">
                                <a href="{{ $userdetail->userdetail->facebook }}">{{ $userdetail->userdetail->facebook }}</a>

                            </span></p>
                        <p class="mb-1 font-13"><strong>Instagram :</strong> <span class="ml-2">
                                <a href="{{ $userdetail->userdetail->instagram }}">{{ $userdetail->userdetail->instagram }}</a>

                            </span></p>

                        <p class="mb-2 font-13"><strong>Rolle :</strong> <span class="ml-2 ">
                                                               {{ $userdetail->roles()->first()->name }}
                            </span></p>
                        <p class="mb-2 font-13"><strong>Texter :</strong> <span class="ml-2 ">
                        ...
                        <p class="mb-2 font-13"><strong>Designer :</strong> <span class="ml-2 ">
                    ...
                    <ul class="social-list list-inline mt-3 mb-0">
                        <li class="list-inline-item">
                            <a href="{{ $userdetail->userdetail->facebook }}" class="social-list-item border-primary text-primary"><i
                                        class="mdi mdi-facebook"></i></a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ $userdetail->userdetail->instagram }}" class="social-list-item border-danger text-danger"><i
                                        class="mdi mdi-instagram"></i></a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ $userdetail->userdetail->website }}" class="social-list-item border-info text-info"><i
