...
@section('content')
    <div class="row mt-2">
        <div class="col-md-6">
            <h3><strong>Benutzerprofil bearbeiten</strong></h3>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <hr/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="first_name" value="{{$first_name}}" id="first_name" placeholder="First Name" required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="last_name" class="col-form-label">Nachname</label>
                                <input type="text" class="form-control" name="last_name" value="{{$last_name}}" id="last_name" placeholder="Last Name">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" name="telephone" value="{{$user->userdetail->telephone}}" id="telephone" placeholder="Telephone" >
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="role" class="form-control" required>
                                @foreach($roles as $role)
                                    ...
                                    {{--    <option value="admin" {{$user->roles()->first()->slug=="admin"?'selected':''}}>Admin</option>
                                <option value="client" {{$user->roles()->first()->slug=="client"?'selected':''}}>Client</option>
                                --}}
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <textarea class="form-control" name="biographical_information" id="biographical_information" placeholder="Biographical Information" >{{$user->userdetail->biographical_information}}</textarea>
                        </div>
                    </div>

                    @can('admin')
                    @if($user->roles()->first()->slug=="employee")
                    <div class="row">
                        <div class="col-md-12">
                            <hr/>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <select name="billing" class="form-control" required>
                                        ...
                                        <option value="1" @if($user->userdetail->billing==1) selected @endif>percentage</option>
                                        <option value="2" @if($user->userdetail->billing==2) selected @endif>fixed</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text"  class="form-control" name="amount" value="{{$user->userdetail->amount}}" placeholder="Amount" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-3 mb-2" style="color: black;">
                            Product
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="form-check-inline">
                                ...
                                <label class="form-check-label" for="check1">
                                    <input type="checkbox" name="resume" value="Resume" class="form-check-input" id="resume" @if($user->userdetail()->first()->employeeproducts()->where('product','resume')->exists()) checked @endif>
                                    Resume
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label" for="check1">
                                    <input type="checkbox" name="website" value="website" class="form-check-input" id="website" {{$user->userdetail->graphic_designer=="1"?'checked':''}}>
                                    Website
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label" for="package">
                                    <input type="checkbox" name="package" value="package" class="form-check-input" id="package" {{$user->userdetail->media_designer=="1"?'checked':''}}>
                                    Package
                                </label>
                            </div>
                        </div>
