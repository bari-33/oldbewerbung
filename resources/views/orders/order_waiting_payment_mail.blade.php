...
<body>
<div>
    <h1 align="center">Deine Bestellung ist fertiggestellt
        und steht zum Download bereit.</h1>
</div>
<div>
    <p>Hallo {{$account_data['user']}}, </p>
    <p>Wir haben Deine Bestellung <b>{{$account_data['order_id']}}</b> fertiggestellt. Sie steht nun für Dich zum
        Download bereit. Die Bestellung wurde jedoch leider noch nicht bezahlt. Bezahle jetzt
        Deine Rechnung und erhalte Zugriff zu der Vollversion.</p>
</div>

<div><h3>Unsere Bankverbindung</h3></div>
...
<div>
    <h4 align="center">Probe Version herunterladen</h4>
    <a href="{{url('login')}}"><button>Herunterladen</button></a>
</div>
