...
<body>
<div>
    <h1 align="center">Die Zahlung ist eingegangen.</h1>
    <h1 align="center">Jetzt Vollversion herunterladen.</h1>
</div>
<div>
    <p>Hallo {{$account_data['user']}}, </p>
    <p>Wir haben Deine Zahlung für die Bestellung <b>{{$account_data['order_id']}}</b> erhalten. Nun kannst du die
        fertigen Unterlagen herunterladen</p>
</div>
...
<div>
    <h4 align="center">Vollversion herunterladen</h4>
...
<div>
    <div>
        <div>
            <h3>STATUS : Rechnung wurde bezahlt</h3>
        </div>
