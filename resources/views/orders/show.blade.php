...
/*            background-color: #4a4da5;*/
        ...
        .express_block input[type="checkbox"]+label{display:inline-block;position:relative;color:#9b9ca2;padding:4px 4px;border:1px solid #d3d3db;border-radius:24px;font-weight:400;cursor:pointer;margin:0 8px 30px;width:390px;text-align:left;}
        ...
        .contactForm .input-group .input-group-addon{min-width:inherit;padding-left:22px;background-color:rgba(0,0,0,0);border-right:0;border-radius:20px 0 0 20px;border-color:#d3d3db;color:#9b9ca2;}
        ...
        /*Slider hover image*/
        #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 16%;  }
        ...
        @media only screen and (max-width: 576px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 29%;left:4%;
                width:103%;}
        ...
        @media only screen and (min-width: 576px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 28%;left:25%  ;}
            /*.contactForm .input-group .input-group-addon{min-width:inherit;background-color:rgba(0,0,0,0);border-right:0;border-radius:20px 0 0 20px;border-color:#d3d3db;color:#9b9ca2;}*/
        ...
        @media only screen and (min-width: 600px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 23%;  }
        }
        ...
        @media only screen and (max-width: 767px) {
            ...
            .express_block input[type="checkbox"] + label svg, .detail_page .express_block .label_tablet svg {
                width: 30px;
            }
        ...
        @media only screen and (min-width: 768px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 28%;  }
        ...
        @media only screen and (min-width: 992px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 27%;  }
            /*.contactForm .input-group .input-group-addon{min-width:inherit;background-color:rgba(0,0,0,0);border-right:0;border-radius:20px 0 0 20px;border-color:#d3d3db;color:#9b9ca2;}*/
        ...
        @media only screen and (min-width: 1200px) {
            #design_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 23%; left:19%;  }
        }



        /*Slider hover image*/
        #website_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 35%;  }
        /* Extra small devices (phones, 600px and down) */
        @media only screen and (max-width: 576px) {
        ...
        @media only screen and (min-width: 576px) {
            #website_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 47%;left:25%;  }
            .my-container{
                width:100%;}
        }
            ...
            /* Small devices (portrait tablets and large phones, 600px and up) */
        @media only screen and (min-width: 600px) {
            #website_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 26%;  }
        }

        /* Medium devices (landscape tablets, 768px and up) */
        @media only screen and (min-width: 768px) {
            #website_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 45%;  }
        }
        ...
        /* Extra large devices (large laptops and desktops, 1200px and up) */
        @media only screen and (min-width: 1200px) {
            #website_slide_image_col {  display: none;  position: absolute;  z-index: 999999;  top: 42%; left:19%;  }
        }
    ...
    <div class="row mt-3">
        <div class="col-md-12 col-sm-12">
            <div class="text-center">
                <h4><font style="vertical-align: inherit;"><font class="" style="vertical-align: inherit;">Kostenlose und unverbindliche Registrierung</font></font></h4>
            </div>
            <div class="separator text-center">
                <hr>
                <a href="{{url('orders')}}" style="background-color: #8883b7;color: white;top: 50%" ><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Produkt wechseln</font></font></a>
            ...
            <div class="card-box brdr-tp-sh">
                <div class="row pb-3" style="border-bottom: 0.5px solid lightgrey" >
                    <div class="col-md-2 col-sm-2">
                        <img src="{{url('public/img/products/'.$product->product_image)}}" style="width:100%;" alt="" >
                    </div>
                    <div class="col-md-8 col-sm-8" >
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <button class="btn btn-md btn-primary" @if($product->getOriginal('popular')==1) style="border-radius: 22px;background-color: #6262de;" @else style="visibility: hidden;background-color: #6262de;" @endif><i class="mdi mdi-star"></i>Sehr berühmt</button>
                            </div>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="separator text-center">
                ...
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Bewerbungs Designs</font></font></a>
        ...
        <div class="col-md-12 col-sm-12">
               ...
               @foreach($design_categories as $category)
                <li class="nav-item colorful-tabs">
                    <a class="nav-link" data-toggle="tab" href="#d{{$category->id}}"
                      style="border-radius: 35px; background-color: {{$category->name}}; padding: 15px;margin: 10px; border: 6px solid white;"
                   ...
                   @endforeach
                   <li class="nav-item colorful-tabs">
                       <a class="nav-link active btn btn-primary mt-2" style="color:white;border-radius:22px;padding-right:30px;padding-left:30px;background-color: #454899;" data-toggle="tab" href="#dall">Alle</a>
                   </li>
            </ul>
            ...
            @foreach($design_categories as $category)
                    ...
                    @foreach($designs as $design)
                        ...
                        <div>
                            <div class="item priceProduct-design my-slider-back-kr design-class-pick" price="{{$design->regular_price}}">
                                <a  id="{{$design->id}}" onclick="getDesignId(this.id)" >
                                    <div class="imgTemp resume-design">
                                        <label for="all-resume-template-0" class="label-hover-cursor">
                                            ...
                                            <img src="{{url('public/img/designs/primary/'.$design->primary_image)}}" data-src="{{url('public/img/designs/secondary/'.$design->secondary_image)}}" class="thumbnail-design" style="width: 150px;height: 100px;">
    ...
    <div class="row mt-3" id="homepage_slider_div">
        <div class="col-md-12 col-sm-12">
            <div class="separator text-center">
                ...
                <hr class="hr" style="margin-left: 0px;">
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Bewerbungs Home Page</font></font></a>
                 <hr class="hr" style="position: relative;top: -17px;margin-right: 0px;">
                        ...
                        <div class="owl-carousel">
                            @foreach($websites as $website)
                                ...
                                @if($website->product_category==$category->name)
                                    <div>
                                        <div class="item priceProduct-design website-class-pick" price="{{$website->regular_price}}">
                                            <a id="{{$website->id}}" onclick="getWebsiteId(this.id)">
                                                <div class="imgTemp resume-design">
                                                    <label for="all-resume-template-0" class="label-hover-cursor">
                                                        <img src="{{url('public/img/websites//primary/'.$website->primary_image)}}" data-src="{{url('public/img/websites/secondary/'.$website->secondary_image)}}" class="thumbnail-website" style="width: 150px;height: 100px;">
    ...
    <div class="row mt-3">
        <div class="col-md-12 col-sm-12">
            <div class="separator text-center">
                 ...
                 <hr class="hr" style="margin-left: 0px;">
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Bearbeitungszeit</font></font></a>
                 <hr class="hr" style="position: relative;top: -17px;margin-right: 0px;">
        ...
        <div class="express_block">
            <div class="text-center">
                ...
                <label for="express">
                    ...
                    <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Express-24h Bearbeitung 59,00 €</font></font></span>
                </label>
                <div class="label_tablet">
                    <svg viewBox="0 0 44 44"><path d="M3.045,22c0-10.091,8.19-18.281,18.281-18.281S39.607,11.909,39.607,22h1.97 c0.035-11.196-9.02-20.285-20.216-20.285S1.075,10.804,1.075,22c0,11.162,9.02,20.217,20.182,20.285v-1.97 C11.201,40.246,3.045,32.057,3.045,22z"></path><path d="M31.003,16.989c0.484-0.312,0.588-0.968,0.276-1.451c-0.312-0.484-0.968-0.588-1.451-0.276l-6.981,4.699 c-0.587-0.414-1.348-0.622-2.108-0.414l-6.151-9.192c-0.311-0.484-0.968-0.588-1.452-0.277c-0.484,0.312-0.587,0.968-0.276,1.452 l6.255,9.296c-0.276,0.553-0.38,1.175-0.242,1.831c0.346,1.348,1.728,2.178,3.076,1.832c1.209-0.311,2.004-1.451,1.9-2.661 L31.003,16.989z"></path><path d="M29.827,34.199c0.795-0.968,1.383-1.797,1.764-2.558c0.379-0.761,0.518-1.452,0.518-2.143 c0-1.175-0.346-2.108-1.071-2.765c-0.69-0.656-1.659-1.002-2.903-1.002c-0.863,0-1.589,0.172-2.246,0.553 c-0.656,0.38-1.141,0.898-1.485,1.555c-0.346,0.657-0.519,1.383-0.519,2.212h2.107c0-0.795,0.174-1.417,0.554-1.866 s0.898-0.691,1.589-0.691c0.588,0,1.037,0.208,1.383,0.588s0.519,0.934,0.519,1.59c0,0.483-0.138,1.002-0.38,1.486 c-0.242,0.483-0.691,1.105-1.313,1.831l-4.216,4.977v1.589h8.501v-1.831h-5.875L29.827,34.199z"></path><path d="M39.228,34.717h-3.318l3.145-5.426l0.174-0.311V34.717z M41.335,34.717V25.87h-2.177l-5.426,9.296 l0.069,1.383h5.46v3.041h2.108v-3.041h1.555v-1.832H41.335z"></path></svg>
                    <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Fertigstellung </font></font></span>
                    <strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;" id="completionDate">Monday 3.11.2019</font></font></strong>
                </div>
                <p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">* der Express-24h Service gilt nur für die Erstellung des Lebenslaufes, Deckblatts und der Anschreiben</font></font></p>
            </div>
</div>
    ...
    <div class="row mt-3">
        <div class="col-md-12 col-sm-12">
            <div class="separator text-center">
                                 <hr class="hr" style="margin-left: 0px;">
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Kontakt</font></font></a>
                 <hr class="hr" style="position: relative;top: -17px;margin-right: 0px;">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
						...
						<span class="input-group-addon my-span-kr">
                            ...
                            <input type="text" class="form-control" name="nickname" placeholder="Nachname"  required>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
						...
						<span class="input-group-addon my-span-kr">
                            ...
                            <input type="number" name="phonenumber" class="form-control" placeholder="Telefonnummer">
                        </div>
                    </div>
                </div>
            </div>
...
<hr class="hr" style="margin-left: 0px;">
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">Kosten</font></font></a>
                 <hr class="hr" style="position: relative;top: -17px;margin-right: 0px;">
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-4 col-sm-offset-1">
            <div class="text-center">
                <div class="price_label h4">
                    <span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gesamtsumme: </font></font></span>
                ...
                @if(!\Illuminate\Support\Facades\Auth::check())
                    ...
                    <div class="info_detail"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nein! </font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                Die Anmeldung ist  </font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">unverbindlich</font></font></strong><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                und völlig kostenlos. </font></font><strong><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"></font></font></strong><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
                                Die Zahlung erfolgt erst nach Fertigstellung der Unterlagen und Vorauskasse zur Expressabwicklung.</font></font></div>
                </div>
                    @endif
            </div>
        </div>
...
<hr class="hr" style="margin-left: 0px;">
                <a href="javascript:void(0)"><font style="vertical-align: inherit;"><font
                                style="vertical-align: inherit;">AGB und Datenschutz</font></font></a>
                 <hr class="hr" style="position: relative;top: -17px;margin-right: 0px;">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="checkbox checkbox-primary mb-2">
            ...
            <label for="checkBox" style="margin-left:12px">
                Ich habe die Allgemeinen Geschäftsbedingungen und die Datenschutzrichtlinien gelesen und stimme zu.
            </label>
        ...
        <div class="text-right">
            @if(\Illuminate\Support\Facades\Auth::check())
                <form method="POST" action="{{url('orders/addOrder')}}" onsubmit="return validateForm()">
                    @csrf
                    @endif
            ...
            @if(!\Illuminate\Support\Facades\Auth::check())
         <button type="submit" class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Kostenlos registrieren</font></font></button>
             @else
          <button type="submit" class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Bestellung hinzufügen</font></font></button>
    ...
    <script type="text/javascript">
        ...
        function valueChanged()
        {
            ...
            if($('#express').is(":checked")) {
                ...
                $('#completionDate').text(days[date.getDay()]+' '+date.getDate()+'.'+(date.getMonth()+1)+'.'+date.getFullYear());
