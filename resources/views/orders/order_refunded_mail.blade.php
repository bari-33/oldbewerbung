...
<body>
<div>
    <h1 align="center">Rückerstattung eingeleitet.</h1>
</div>
<div>
    <p>Hallo {{$account_data['user']}}, </p>
    <p>Soeben haben wir eine Rückerstattung für die Bestellung <b>{{$account_data['order_id']}}</b> eingeleitet.</p>
</div>
