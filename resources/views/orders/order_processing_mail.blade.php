...
<body>
<div>
    <h1 align="center">Deine Bestellung befindet
        sich in Bearbeitung.</h1>
</div>
<div>
    <p>Hallo {{$account_data['user']}}, </p>
    <p>vielen Dank, dass Du Dich für Bewerbung.one entschieden hast!
        Wir haben die Daten für Deine Bestellung <b>{{$account_data['order_id']}}</b> erhalten. Diese wird
        gerade bearbeitet.</p>
</div>
