...
<div class="row mb-4" style="padding-bottom: 0px;border-radius: 0px 0px 25px 25px;background-color: #323759;margin-left: -27px;margin-right: 0px;width: 104%;padding-left: 15px;padding-right: 15px;">
        <div class="col-md-4 mt-3 mb-3">
                        <h4 class="page-title" style="color:white">Design</h4>
        </div>
        <div class="offset-md-4 col-md-2 mt-3" style="margin-right: -1%">
            <button class="btn btn-success" style="border-radius: 25px;border-color: white;" onclick="window.location='{{url('designs/create')}}'">Design hinzufügen</button>
        </div>
...
<center>
    <form action="{{url('designs/search')}}" method="POST">
        @csrf
    ...
    <div class="col-md-2">
        <form action="{{url('designs/searchCategory')}}" name="form" method="POST">
            @csrf
            <select name="category" class="form-control" style="border-radius: 25px;border-color: white;" onchange="this.form.submit()" >
        ...
        <div class="table-wrapper">
            ...
            <table id="designtable" class="table mb-0" style="color: #000;">
                ...
                <tr>
                    ...
                    <td><img src="{!! asset('public/img/designs/primary/'.$design->primary_image) !!}" width="150" height="150"  class="img-thumbnail"></td>
                    <td><img src="{!! asset('public/img/designs/secondary/'.$design->secondary_image) !!}" width="150" height="150" class="img-thumbnail"></td>
                    <td>{{$design->regular_price}}</td>
                    <td>{{$design->product_category}}</td>
                    @if($trash==false)
                    <td><button onclick="window.location='{{url('designs/'.$design->id.'/edit')}}'" class="btn btn-primary btn-sm mr-2"><i class="ti-pencil"></i></button>



                     
                        <a href="{{url('designs/destroy',['id'=>$design->id])}}" class="delete-confirm  btn btn-danger btn-sm"><i class="ti-close"></i></a>
